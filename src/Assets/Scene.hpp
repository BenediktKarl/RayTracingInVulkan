...
namespace Assets
{
	...
	public:
		...
		const Vulkan::Buffer& OccupancyBuffer() const { return *occupancyBuffer_; }
		const Vulkan::DeviceMemory& OccupancyBufferMemory() const { return *occupancyBUfferMemory_; }
	...
	private:
		...
		std::unique_ptr<Vulkan::Buffer> occupancyBuffer_;
		std::unique_ptr<Vulkan::DeviceMemory> occupancyBUfferMemory_;
